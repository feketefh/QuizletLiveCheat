(function () {
	...
	function add_css(target) {
		append_styles(target, "svelte-18s9eem", ".hud.svelte-18s9eem.svelte-18s9eem{position:absolute;width:300px;height:200px;z-index:999999999999;background-color:rgba(0, 0, 0, 0.9);border-radius:0.5em;display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;color:white;touch-action:none;user-select:none;cursor:move;will-change:transform}.hud.svelte-18s9eem .row.svelte-18s9eem{display:flex;flex-direction:row;justify-content:space-between;align-items:space-between;width:100%}.hud.svelte-18s9eem .answer.svelte-18s9eem{width:70%;height:50px;font-family:Verdana, Geneva, Tahoma, sans-serif;font-size:1em;border-radius:0.5em;background-color:white;color:black;border:none;transition:transform 0.3s ease}.hud.svelte-18s9eem .answer.svelte-18s9eem:active{transform:scale(0.93)}.hud.svelte-18s9eem .help.svelte-18s9eem{display:flex;flex-direction:column;align-items:center;width:85%}.hud.svelte-18s9eem .helpControl button.svelte-18s9eem{width:25px;height:25px;border-radius:0.5em;background-color:white;border:none;transition:transform 0.3s ease;margin:5px;color:black}");
	}
	...
	function create_if_block(ctx) {
		...
		return {
			c() {
				...
				button2.textContent = ">";
				attr(button0, "class", "answer svelte-18s9eem");
				attr(button1, "class", "svelte-18s9eem");
				attr(div1, "class", "display");
				attr(button2, "class", "svelte-18s9eem");
				attr(div2, "class", "row helpControl svelte-18s9eem");
				attr(div3, "class", "help svelte-18s9eem");
				attr(div4, "class", "hud svelte-18s9eem");
				set_style(div4, "transform", "translate(" + /*x*/ ctx[2] + "px, " + /*y*/ ctx[3] + "px)");
			...
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						...
						listen(window, "touchmove", /*handleMove*/ ctx[6]),
