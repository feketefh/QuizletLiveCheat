	...
	function create_if_block(ctx) {
		...
		return {
			...
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						listen(button0, "click", /*handleAnswer*/ ctx[5]),
						listen(button1, "click", /*click_handler*/ ctx[9]),
						listen(button2, "click", /*click_handler_1*/ ctx[10])
					];
	...
	function create_fragment(ctx) {
		...
		return {
			...
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						action_destroyer(/*attachListener*/ ctx[3].call(null, window_1)),
						listen(window_1, "keydown", /*onKeyDown*/ ctx[6])
					];
