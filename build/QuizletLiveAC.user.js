...
(function () {
	...
	function add_css(target) {
		append_styles(target, "svelte-1dy6vrn", ".hud.svelte-1dy6vrn.svelte-1dy6vrn{position:fixed;width:300px;height:200px;z-index:999999999999;background-color:rgba(0, 0, 0, 0.9);border-radius:0.5em;display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;color:white;touch-action:none;user-select:none}.hud.svelte-1dy6vrn .row.svelte-1dy6vrn{display:flex;flex-direction:row;justify-content:space-between;align-items:space-between;width:100%}.hud.svelte-1dy6vrn .answer.svelte-1dy6vrn{width:70%;height:50px;font-family:Verdana, Geneva, Tahoma, sans-serif;font-size:1em;border-radius:0.5em;background-color:white;color:black;border:none;transition:transform 0.3s ease}.hud.svelte-1dy6vrn .answer.svelte-1dy6vrn:active{transform:scale(0.93)}.hud.svelte-1dy6vrn .help.svelte-1dy6vrn{display:flex;flex-direction:column;align-items:center;width:85%}.hud.svelte-1dy6vrn .helpControl button.svelte-1dy6vrn{width:25px;height:25px;border-radius:0.5em;background-color:white;border:none;transition:transform 0.3s ease;margin:5px;color:black}");
	}
	...
	function create_if_block(ctx) {
		...
		return {
			c() {
				...
				button2.textContent = ">";
				attr(button0, "class", "answer svelte-1dy6vrn");
				attr(button1, "class", "svelte-1dy6vrn");
				attr(div1, "class", "display");
				attr(button2, "class", "svelte-1dy6vrn");
				attr(div2, "class", "row helpControl svelte-1dy6vrn");
				attr(div3, "class", "help svelte-1dy6vrn");
				attr(div4, "class", "hud svelte-1dy6vrn");
	...
	function create_fragment(ctx) {
		...
		return {
			...
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						listen(window_1, "keydown", /*onKeyDown*/ ctx[10]),
						listen(window_1, "mousemove", /*handleMove*/ ctx[7]),
						listen(window_1, "mouseup", /*handleEnd*/ ctx[6]),
						listen(window_1, "touchmove", prevent_default(/*handleMove*/ ctx[7])),
						listen(window_1, "touchend", /*handleEnd*/ ctx[6])
					];
	...
	function instance($$self, $$props, $$invalidate) {
		...
		function handleMove(event) {
			...
			$$invalidate(2, x = Math.min(Math.max(0, clientX - startX), maxX));
			$$invalidate(3, y = Math.min(Math.max(0, clientY - startY), maxY));
		}
