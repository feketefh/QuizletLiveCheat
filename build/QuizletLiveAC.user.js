...
(function () {
	...
	function add_css(target) {
		append_styles(target, "svelte-1j11i42", ".hud.svelte-1j11i42.svelte-1j11i42{position:absolute;width:300px;height:200px;z-index:999999999999;background-color:rgba(0, 0, 0, 0.9);border-radius:0.5em;display:flex;flex-direction:column;justify-content:space-evenly;align-items:center;color:white;will-change:transform;touch-action:none;user-select:none;cursor:move}.hud.svelte-1j11i42 .row.svelte-1j11i42{display:flex;flex-direction:row;justify-content:space-between;align-items:space-between;width:100%}.hud.svelte-1j11i42 .answer.svelte-1j11i42{width:70%;height:50px;font-family:Verdana, Geneva, Tahoma, sans-serif;font-size:1em;border-radius:0.5em;background-color:white;color:black;border:none;transition:transform 0.3s ease}.hud.svelte-1j11i42 .answer.svelte-1j11i42:active{transform:scale(0.93)}.hud.svelte-1j11i42 .help.svelte-1j11i42{display:flex;flex-direction:column;align-items:center;width:85%}.hud.svelte-1j11i42 .helpControl button.svelte-1j11i42{width:25px;height:25px;border-radius:0.5em;background-color:white;border:none;transition:transform 0.3s ease;margin:5px;color:black}");
	}
	...
	function create_if_block(ctx) {
		...
		return {
			c() {
				...
				button2.textContent = ">";
				attr(button0, "class", "answer svelte-1j11i42");
				attr(button1, "class", "svelte-1j11i42");
				attr(div1, "class", "display");
				attr(button2, "class", "svelte-1j11i42");
				attr(div2, "class", "row helpControl svelte-1j11i42");
				attr(div3, "class", "help svelte-1j11i42");
				attr(div4, "class", "hud svelte-1j11i42");
