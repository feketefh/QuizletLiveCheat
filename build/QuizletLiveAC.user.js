	...
	function create_if_block(ctx) {
		...
		return {
			c() {
				...
				button2.textContent = ">";
				attr(button0, "class", "answer svelte-ntd8nm");
				attr(button1, "class", "svelte-ntd8nm");
				attr(div1, "class", "display");
				attr(button2, "class", "svelte-ntd8nm");
				attr(div2, "class", "row helpControl svelte-ntd8nm");
				attr(div3, "class", "help svelte-ntd8nm");
				attr(div4, "class", "hud svelte-ntd8nm");
